...
6)in_transit_stock = SUM(`In Transit Quantity`)    or we need to calculate ("in_transit_stock = vendor_increff+ vendor_to_pc+ vendor_to_fba+ vendor_to_fbf+ vendor_to_kv+ pc_to_fba+ pc_to_fbf+ pc_to_increff+ kv_to_fba+ kv_to_fbf")
